...
Data_file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)).split('RobustTKG')[0]+'Data')
...
if __name__ == '__main__':
    ...
    for ratio in Ratios:
        ...
        handler.calculate_history_freq()
        # handler.load_data(ratio, Noise_strategy)
        # handler.load_data_cut_relation(ratio, Noise_strategy)
